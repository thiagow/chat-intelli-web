    ...
    async (msg: Message) => {
      const ok = window.confirm(
        'Deletar essa mensagem pra todos? ' +
          ...
          'Em WhatsApp Cloud API e Instagram, ela some apenas no Intelli Chat ' +
      ...
      try {
        ...
        if (result.succeededRemote) {
          ...
          toast.warning(
            'Mensagem deletada só no Intelli Chat. ' +
                        ...
                        <div
                          ...
                          title={
                            msg.revokeSucceededRemote
                              ...
                              : 'Deletada apenas no Intelli Chat — o cliente ainda pode estar vendo no app dele.'
                          }
                        >
